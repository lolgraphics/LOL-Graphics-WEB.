...
export const defaultCards: Card[] = [
  {
    ...
    image: 'https://nerdbot.com/wp-content/uploads/2022/01/league-of-legends-2022-official-art.jpg',
    colorPallete: 'bg-[#2a4563]',
  },
  {
    id: 2,
    title: 'Team Fight Tatics',
    image: 'https://miro.medium.com/v2/resize:fit:1200/1*uIX2cnzRkgYSRR6NEmnarQ.jpeg',
    colorPallete: 'bg-[#fbbb40]',
  },
  {
    id: 3,
    title: 'Valorant',
